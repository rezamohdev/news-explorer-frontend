        ...
        <div className={`navbar ${inSavedNews && 'navbar_saved-news'}`}>
            ...
            <div className="navbar__right-side">
                <Link to='/' className="navbar__link">
                    <button className={`navbar__button`}>Home</button> </Link>
                {isLoggedIn &&
                    (<Link to='/saved-news'>
                        <button
                            className={`navbar__button ${inSavedNews ? 'navbar__button_saved-news' : 'navbar__button_active'}`}>Saved Articles</button>
                    </Link>)}
                {isLoggedIn == true ?
                    (
