    ...
    return (
        <ModalWithForm isOpen={isOpen} onClose={handleCloseModal} title='Sign up' name="signup" buttonText={buttonText} onSubmit={handleOnSubmit}>
            <fieldset className='form__fieldset' >
                ...
                <input name='email' type='email' value={values.email || ""} placeholder='email' minLength={1} maxLength={30} className='form__input' onChange={handleChange} />

                <label htmlFor='password' className='form__label'>Password</label>
                <input name='password' type='password' value={values.password || ''} placeholder='password' minLength={1} maxLength={30} className='form__input' onChange={handleChange} />

                <label htmlFor='username' type='text' className='form__label'>Username</label>
                <input name='username' value={values.username || ''} placeholder='username' minLength={1} maxLength={30} className='form__input' onChange={handleChange} />
            </fieldset>
